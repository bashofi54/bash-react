    ...
    render() {
        return (
            <div style={{margin:'100px auto', border:'1px solid gray', padding:'20px'}}>
                        <form onSubmit={this.handSubmite}>
                            <label>
                            ...
                            <label> 
                                Member:
                                <input type='checkbox' checked={this.state.member} name='member' onChange={ e => this.setState({member: e.target.checked})} value={this.state.member}/>
                            </label> <br />
                            <br />
